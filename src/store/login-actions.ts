...
export const logout = (dispatch: AppDispatch) => {
  ...
  dispatch(itemsActions.clearAll(null));
};

export const login = (authData: TauthData, history: string[]) => {
...
export const signup = (authData: TauthData, history: string[]) => {
  return async (dispatch: AppDispatch) => {
    fetch(SIGNUP_URL, {
      method: "PUT",
