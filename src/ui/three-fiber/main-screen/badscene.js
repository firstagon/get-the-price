...
import { useGLTF, MeshTransmissionMaterial, Environment, Lightformer, Box } from '@react-three/drei'
...
const Scene = (props) => {
    ...
    return <Canvas height='100px' width='200px' onClick={click} shadows dpr={[1, 1.5]} gl={{ antialias: false }} camera={{ position: [0, 0, 15], fov: 17.5, near: 1, far: 20 }} {...props} >
